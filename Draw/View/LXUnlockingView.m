...
- (void)p_handleForTouchesEndedOrCancelled:(NSSet *)touches
{
    ...
    void (^completion)(void) = [self p_redrawByAccordingToIsCorrect:isCorrect];
...
- (void (^)(void))p_redrawByAccordingToIsCorrect:(BOOL)isCorrect
{
...
- (void)p_clearScreenWithCompletion:(void (^)(void))completion
{
    // 让线条显示 1s 再清除屏幕上的线条.

...
- (void)touchAction:(UITouch *)touch
{
    ...
    switch (touch.phase) {
        ...
        case UITouchPhaseCancelled:
            ...
            [[LXImageManger sharedImageManger] addImage:self.bitmap];
...
- (void)clear
{
    ...
    [[LXImageManger sharedImageManger] removeAllImages];
...
- (void)undo
{
    ...
    self.bitmap  = [[LXImageManger sharedImageManger] imageForUndo];
    self.canUndo = [[LXImageManger sharedImageManger] canUndo];
    self.canRedo = YES;
...
- (void)redo
{
    ...
    self.bitmap  = [[LXImageManger sharedImageManger] imageForRedo];
    self.canRedo = [[LXImageManger sharedImageManger] canRedo];
    self.canUndo = YES;
